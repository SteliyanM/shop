...
from bokatas_store.products.forms import CreateProductForm, CreateReviewForm, AddProductToCartBaseForm
...
class DetailsProductView(views.DetailView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        return render(request, self.template_name, {"cart_form": cart_form, "form": form, "object": self.get_object()})
